        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/jaippurultra" target="_blank" rel="noopener noreferrer" className="text-primary-container cursor-pointer hover:scale-110 transition-transform">
                <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
              ...
              <a href="mailto:info@jaipurultra.com" className="text-primary-container cursor-pointer hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:col-span-1 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4 font-title uppercase tracking-widest text-sm">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a className={`hover:text-primary-container transition-all normal-case ${isLightMode ? 'text-[#53392b]' : 'text-secondary'}`} href="mailto:info@jaipurultra.com">info@jaipurultra.com</a>
              </div>
              <div className="flex flex-col gap-1">
